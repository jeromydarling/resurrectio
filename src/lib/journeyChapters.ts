...
const LEGACY_TO_CHAPTER: Record<string, Chapter> = {
  ...
  'Agreement Pending': 'Onboarding',
  'Agreement Signed': 'Onboarding',
  'First Volume': 'First Placement',
...
export const CHAPTER_COLORS: Record<Chapter, string> = {
  ...
  'Proposal Shared': 'hsl(38, 92%, 50%)',
  'Onboarding': 'hsl(25, 95%, 53%)',
  'First Placement': 'hsl(142, 71%, 45%)',
...
export const CHAPTER_BADGE_CLASS: Record<Chapter, string> = {
  ...
  'Proposal Shared': 'stage-proposal',
  'Onboarding': 'stage-agreement',
  'First Placement': 'stage-signed',
