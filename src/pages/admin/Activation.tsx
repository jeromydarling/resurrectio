...
export default function Activation() {
    ...
    return (
      <MainLayout title="Activation">
        <div className="text-center py-20">
          ...
          <p className="text-muted-foreground">Complete onboarding to activate your Resurrectio workspace.</p>
        </div>
      </MainLayout>
    );
  }
  ...
  return (
    <MainLayout title="Resurrectio Activation" subtitle="Confirm your workspace is alive and well">
