/**
 * AdminHowTo — In-app admin guide for the Resurrectio administrative console.
 *
...
const tenantSections: GuideSection[] = [
    ...
    items: [
      {
        ...
        a: 'Territories are the unified geography layer in Resurrectio. They replace the old metro-only model with support for metros, county bundles, states, countries, and mission fields. Each territory type has different activation slot costs.',
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: 'For HubSpot, Salesforce, and Microsoft Dynamics 365, Resurrectio supports bi-directional sync. Changes you make in Resurrectio can be written back to your external CRM automatically. If both systems edited the same record, a conflict is flagged for your review — Resurrectio never overwrites without your consent.',
      },
      {
        q: 'How do I resolve sync conflicts?',
        a: 'When a conflict is detected, it appears in the Integrations page under your connector. You can choose to accept the Resurrectio version, the external CRM version, or merge them manually. Conflicts are always flagged — never silently overwritten.',
      },
    ],
  },
  // ── SHARED SECTIONS (visible to all admins) ──
  {
    ...
    items: [
      {
        q: 'What is Communio?',
        a: 'Communio is the cooperative sharing layer between organizations on Resurrectio. You can form groups, share anonymized signals, co-sense community momentum, and discover shared patterns — all without exposing private data.',
      },
      {
...
const operatorSections: GuideSection[] = [
  ...
  },
  {
    ...
    icon: Compass,
    title: 'Resurrectio Companion & Compass Posture',
    badge: 'All Roles',
    items: [
      {
        q: 'What is the compass icon in the bottom-right corner?',
        a: 'That is the Resurrectio Companion — your personal guide to the platform. Tap it to open a conversation where you can ask questions, log activities, or request help with anything in Resurrectio.',
      },
      {
