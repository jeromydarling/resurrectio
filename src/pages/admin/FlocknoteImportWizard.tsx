  ...
  return (
    <div className="p-6 max-w-3xl mx-auto space-y-6">
      <div className="flex items-center gap-3 mb-2">
        ...
        <HelpTip text="Import people, groups, and memberships from Flocknote CSV exports into Resurrectio." />
      </div>
      <p className="text-muted-foreground text-sm">
        Bring your community relationships from Flocknote into Resurrectio. Your original data stays untouched.
      </p>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-lg flex items-center gap-2">
              ...
              <HelpTip text="Shows how your CSV columns map to Resurrectio fields. Unknown columns are flagged but preserved." />
            </CardTitle>
          </CardHeader>
          <CardContent className="space-y-4">
            {peopleNorm && (
