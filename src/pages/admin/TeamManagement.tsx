      ...
      <div className="space-y-6 max-w-4xl mx-auto" data-testid="team-management-root">
        ...
        <div className="text-xs text-muted-foreground flex items-start gap-2 p-3 rounded-lg bg-muted/30">
          ...
          <div>
            ...
            <p><strong>What:</strong> Manage who has access to your Resurrectio workspace and what experience they see.</p>
            <p><strong>Where:</strong> This page is available to Stewards from Admin → Team.</p>
            <p><strong>Why:</strong> Resurrectio is invite-only. Only stewards can add or remove team members, ensuring your community data stays protected.</p>
          </div>
        </div>
      </div>
    </MainLayout>
