...
const careSections: CareSection[] = [
  {
    ...
    description: 'Your first steps as a companion in Resurrectio.',
    content: [
      'Resurrectio is a relationship memory system — not compliance software. It helps you remember the people you accompany through stories, milestones, and gentle reflection.',
      'This guide is for mentors, sponsors, and companions walking with returning citizens through reentry. After signing up, add the people you walk with under "People." Each person becomes a living record of your shared journey.',
  ...
  },
  {
    ...
    content: [
      ...
      'If you also work with an organization on Resurrectio, those are separate workspaces with separate data.',
  ...
  },
  {
    ...
    description: 'How Resurrectio works when your organization uses it too.',
    content: [
      'If your organization uses Resurrectio, you\'ll be invited as a Companion. Your organization workspace is separate from any personal Solo workspace.',
      'Companion workspaces are how mentors track their relationships with returning citizens, their families, and the case management team.',
  ...
  },
  {
    ...
    content: [
      ...
      'Resurrectio preserves that memory — for mentors, sponsors, and companions walking with returning citizens through reentry, as well as caregivers, spiritual directors, coaches, and anyone who accompanies another person.',
  ...
  },
  {
    ...
    description: 'Resurrectio features that aren\'t part of companion workspaces.',
    content: [
      ...
      <div className="max-w-3xl mx-auto px-4 py-8 space-y-8">
        ...
        <div className="space-y-2">
          ...
          <p className="text-muted-foreground">
            Everything you need to know about using Resurrectio™ as a companion — solo or with an organization.
          </p>
          <p className="text-sm text-muted-foreground italic">
            For mentors, sponsors, and companions walking with returning citizens through reentry.
          </p>
        </div>
        ...
        <Card className="border-primary/20 bg-primary/5">
          <CardContent className="pt-4">
            <p className="text-sm text-foreground">
              Resurrectio is not compliance software. It's a relationship memory system —
